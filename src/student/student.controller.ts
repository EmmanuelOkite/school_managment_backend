...
export class StudentController {
  ...
  @ApiOperation({
    ...
    description:
      'Registers a new student in the system. The student ID is ' +
      'auto-generated by the server (format: STU-{year}-{6-digit sequence}) ' +
  ...
  @ApiResponse({
    ...
    schema: {
      example: { message: 'Student "STU-2026-000001" deleted successfully.' },
    },
  })
  @ApiResponse({ status: 404, description: 'Student not found.' })
